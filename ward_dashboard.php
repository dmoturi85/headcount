<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'Ward Head') {
...
$sql = "SELECT * FROM employees WHERE ward = ?";
...
<div class="content">
    <h3>Ward Dashboard - <?= htmlspecialchars($ward) ?></h3>
